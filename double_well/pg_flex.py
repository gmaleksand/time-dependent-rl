...
def ModifiedFanOut():   #https://jax.readthedocs.io/en/latest/_modules/jax/example_libraries/stax.html#FanOut
    ...
    def init_fun(rng, input_shape):
        ...
        state_shape = input_shape[:-1] + (input_shape[-1]-1,)
        return ([time_shape, state_shape], ())
    ...
    def apply_fun(params, inputs, **kwargs):
        ...
        remaining_inputs = inputs.take(indices=jnp.arange(1,jnp.shape(inputs)[-1]), axis=-1)#remaining_inputs = inputs[:, 1:]
        return [time_input, remaining_inputs]
