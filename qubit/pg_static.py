...
while epoch < N_epochs:
    ...
    if epoch==N_epochs-1:
        env.Render((epoch,rewards), trajectory_numbers_to_show=[18, 34, 43, 92]) # these trajectories were chosen so that they pass through different parts of the Bloch sphere.
        render()
